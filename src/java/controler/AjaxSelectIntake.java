 ...
 * @author xmore mmohz
 */
public class AjaxSelectIntake extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String id = request.getParameter("intakename");
        // ArrayList<Program_Intake>intake = new ArrayList<>();
        Program_Intake intake;
        intake = IntakeDB.SelectIntakeById(id);
        Gson gson = new Gson();
